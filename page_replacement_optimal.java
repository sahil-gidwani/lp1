public class page_replacement_optimal {
    ...
    // Function to find the frame that will not be used recently in future after
    // given index in pg[0..pn-1]
    ...
    public static void main(String[] args) {
        ...
        int pg[] = { 0, 2, 1, 6, 4, 0, 1, 0, 3, 1, 2, 1 };
        int pn = pg.length;
        int fn = 4;
